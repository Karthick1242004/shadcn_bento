        ...
        <div className="w-full md:w-[260px] flex-shrink-0 flex flex-col overflow-y-scroll h-[95vh] pr-4">
          <div className="flex flex-col gap-16">
            ...
            <div className="space-y-6">
              ...
              <p className={`${inter.className} text-white/50 text-sm font-light`}>
                As a passionate and creative Brand Designer, I bring a unique blend of artistic vision and strategic
                thinking to every project. With years of experience in crafting compelling visual narratives, I've honed
                my skills in graphic design, motion graphics, and digital media. My approach is rooted in understanding
                the core values of a brand and translating them into visually striking and emotionally resonant designs.
              </p>
              <p className={`${inter.className} text-white/50 text-sm font-light`}>
                I thrive in collaborative environments where I can contribute to shaping a brand's identity across
                various platforms. My expertise extends to creating cohesive design systems, developing engaging social
                media content, and producing impactful marketing materials. I'm always eager to explore new design
                trends and technologies, ensuring that the brands I work with stay at the forefront of visual
                communication.
              </p>
            </div>
            <Link
