          ...
          <div className="flex flex-col gap-16">
            ...
            >
              <div className="space-y-6">
                ...
                <p>
                Founder of Caliber Tech & Folio Lynkr, freelancing fullstack developer in MERN stack, frontend developer in NEXT JS and also a videographer
                </p>
                <p>
                I am a engineering student who is currently pursuing BE Computer Science in Kongu Enginnering College in Tamil Nadu. Iam a fullstack developer who works in MERN stack technology and also a frontend developer in NEXT JS frame work. Started Caliber Tech and did some projects for small vendors, Worked on many freelancing projects which are listed below in this web page. Won competitions in web development and also participated in Smart India Hackathon 2023.
                </p>
                <p>Download my resume by clicking the button </p>
                <Link 
                  href="https://drive.usercontent.google.com/download?id=1aFwuoxRl8SetHyDoY6pxV_aJKLE9GSer&export=download&authuser=0"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-8" >
                <div className={`${inter.className} text-white/50 text-sm font-light`}style={{ fontSize: `${0.875 * textSize}rem` }} >
                  <p className="text-white/70 font-medium">Kongu Engineering College</p>
                  <p>Bachelor of Engineering in Computer Science and Engineering</p>
                  <p className="text-white/70">GPA: 7.34</p>
                  <p className="text-white/30">Erode, Tamil Nadu</p>
                  <p className="text-white/30">Nov. 2021 – May 2025</p>
                </div>

                <div className={`${inter.className} text-white/50 text-sm font-light`} style={{ fontSize: `${0.875 * textSize}rem` }}>
                  <p className="text-white/70 font-medium">Rasi International CBSE School</p>
                  <p>Higher Secondary Certificate (HSC)</p>
                  <p className="text-white/70">83.6 Percentage</p>
                  <p className="text-white/30">Namakkal, Tamil Nadu</p>
                  <p className="text-white/30">May 2020 – April 2021</p>
                </div>

                <div className={`${inter.className} text-white/50 text-sm font-light`} style={{ fontSize: `${0.875 * textSize}rem` }}>
                  <p className="text-white/70 font-medium">Sri Vidya Mandir CBSE School</p>
                  <p>Secondary School Leaving Certificate (SSLC)</p>
                  <p className="text-white/70">83.2 Percentage</p>
                  <p className="text-white/30">Salem, Tamil Nadu</p>
                  <p className="text-white/30">May 2018 – April 2021</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className={`${inter.className} text-white/50 text-sm font-light`} style={{ fontSize: `${0.875 * textSize}rem` }}>
                  ...
                  <div className="flex gap-4 mt-1">
                    <Link href="https://github.com/Karthick1242004" className="text-white/70 hover:text-white/90 flex items-center gap-1">
                    ...
                    <Link href="https://www.linkedin.com/in/karthickrajan-s/" className="text-white/70 hover:text-white/90 flex items-center gap-1">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
